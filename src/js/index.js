...
const d = document,
	...
	$each = (sel, call, p = d) => (typeof sel === 'string' ? $$(sel, p): sel).forEach(call),
	$_oo = {
		rootMargin: '0px',
		threshold: 0.2,
	},
...
1.
Преймущество:
- Полностью удаленное обучение.
- Программа рассчитана на 2025 год+ (Технологии, какие будут востребованы в следующем году)
- Портфолио коммерческого уровня
- Специальная авторская методика (с лучшими практиками для усвоения информации)) сделать тест чтоб показать что рабочая методика
- Еще фитчеры
- Поддержка в комьюнити
- Обучение до 7 человек в группе (2 занятия в неделю 1.5 час)
- 1 занятие в неделю с ментор 1 на 1 (30 мин)
- Это групповой менторство ( Нет цели отчитать и идти дальше. Есть цель, чтобы поняли все).
- Интерактивный способ обучение (тест)

Причины обучатся Javascript
1. Наиболее используемые языки программирования среди разработчиков во всем мире по состоянию на 2024 год
https://www.statista.com/statistics/793628/worldwide-developer-survey-most-used-languages/

2. Высокий спрос на рынке труда
3. Быстрый старт в карьере
4 .........
...
Систематизируете текущие знания и восполните пробелы. Начнете свободно писать код любой сложности уже через три месяца обучения
...
Погрузитесь в основы Frontend-разработки и сможете самостоятельно создавать web-сайты или приложения для бизнеса. Будете тестировать свои идеи и привлекать больше клиентов
((КНОООООПКА) -> Проверить подходил ли тебе это направлениe


На курсе вы научитесь ( текст переделать)


Разберетесь в работе с HTML и CSS, узнаете, как улучшить пользовательский опыт и достичь идеальной верстки
Использовать HTML, CSS и работать в Figma
Познакомитесь со структурами и библиотеками JavaScript, сможете писать легко читаемый код и сверстаете ваш первый сайт
Работать с JavaScript и библиотекой React
Изучите TypeScript и Node.js. Начнете выполнять задачи как Frontend-, так и Backend-разработчика
Создавать сайты повышенной сложности
Будете не только верстать, но и искать баги в работе сайтов и приложений. Освоите автоматизированное и ручное тестирование
